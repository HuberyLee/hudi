 ...
 */
public abstract class AdbSpecificParquetRecordReaderBase<T> extends RecordReader<Void, T> {
  protected Path file;
  ...
  protected static final class AdbValuesReaderIntIterator extends IntIterator {
    ValuesReader delegate;

    public AdbValuesReaderIntIterator(ValuesReader delegate) {
  ...
  protected static final class AdbRLEIntIterator extends IntIterator {
    RunLengthBitPackingHybridDecoder delegate;

    public AdbRLEIntIterator(RunLengthBitPackingHybridDecoder delegate) {
      this.delegate = delegate;
    }
